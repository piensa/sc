...
from geonode import get_version, __file__ as geonode_path
...
PROJECT_ROOT = os.path.abspath(os.path.dirname(geonode_path))
...
# SECRET_KEY = '************************'
# Make this unique, and don't share it with anybody.
SECRET_KEY = os.getenv('SECRET_KEY', "v$81i#q195o^jqm)u$+9)gitv32sglz!-83_m^s-&9l%+$*g7z")
...
if EMAIL_ENABLE:
    ...
    EMAIL_HOST_PASSWORD = ''
    EMAIL_USE_TLS = False
    DEFAULT_FROM_EMAIL = 'sc <no-reply@sc>'
...
CLIENT_RESULTS_LIMIT = 1500
API_LIMIT_PER_PAGE = 1500
FREETEXT_KEYWORDS_READONLY = False
RESOURCE_PUBLISHING = False
ADMIN_MODERATE_UPLOADS = False
GROUP_PRIVATE_RESOURCES = False
...
SITENAME = os.getenv("SITENAME", 'sc')
